...
const NewsArticleDetail = () => {
  ...
  const standardArticleType = getStandardArticleType(article.articleType);
      ...
      <div className="bg-gradient-to-b from-gray-900 to-blue-900 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Breadcrumb.Item title={article.articleType || "Uncategorized"} />
          </Breadcrumb>
            ...
            <Card className="shadow-lg rounded-lg overflow-hidden border-0">
              ...
              <div className="flex justify-between items-center mb-6">
                <Space className="text-gray-500">
                  <CalendarOutlined /> Published on {formattedDate}
                </Space>
          ...
          <Col xs={24} lg={8}>
            ...
            >
              <div className="mb-4">
                ...
                <div className="mt-1">
                  <Tag color={tagColor}>
                    {standardArticleType || "Uncategorized"}
                  </Tag>
                </div>
              </div>
