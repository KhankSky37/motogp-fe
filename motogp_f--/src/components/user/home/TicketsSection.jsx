...
import randomImg12 from "../../../assets/race-car-motorcycle-racetrack-after-260nw-1737545399.webp";
import randomImg13 from "../../../assets/a-racing-track-with-twisting-traffic-blurred-background-bokeh-the-concept-of-racing-and-fast-driving-photo.jpg";
              ...
              <div className="h-[230px] overflow-hidden relative">
                ...
                >
                  ...
                  <div className="absolute top-0 left-0 p-4 flex items-start gap-2 z-10 flex-col">
                    <div className="font-MGPText font-medium bg-red-600 px-2 py-1 rounded-lg">Buy Now</div>
