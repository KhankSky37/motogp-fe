      ...
      <Footer className={"py-4 border-t"}
          ...
          <div className={"p-2 flex flex-col items-center border-b"}>
            ...
            <ul className="flex justify-center gap-20 items-center my-4">
              <li><a href="https://www.qatarairways.com/es-es/homepage.html"><img className="w-[60px] h-auto" src={sponsor} alt="logo" /></a></li>
              <li><a href="https://www.tissotwatches.com/en-en"><img className="w-[60px] h-auto" src={tissot} alt="logo" /></a></li>
              <li><a href="https://www.michelinmotorsport.com/en/motorsport/"><img className="w-[60px] h-auto" src={michelin} alt="logo" /></a></li>
              <li><a href="https://www.bmw-m.com/en/fastlane/motogp.html"><img className="w-[60px] h-auto" src={bwm} alt="logo" /></a></li>
              <li><a href="https://estrellagalicia00.es/"><img className="w-[60px] h-auto" src={estrellaGalicia} alt="logo" /></a></li>
              <li><a href="https://www.dhl.com/vn-vi/home/about-us/partnerships.html?locale=true"><img className="w-[60px] h-auto" src={dhl} alt="logo" /></a></li>
            </ul>
          </div>
          <div className="flex justify-between gap-x-16 py-6 px-32">
            ...
            <div>
              ...
              <ul className="space-y-2 text-[18px]">
                ...
                <li><a href="#">About MotoGP™</a></li>
                <li><a href="#">Join MotoGP™</a></li>
              </ul>
            </div>

            {/* Cột 3 */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Tickets & Hospitality</h3>
              <ul className="space-y-2 text-[18px]">
            ...
            <div>
              ...
              <ul className="space-y-2 text-[18px]">
                <li><a href="#">MotoGP™ Fantasy</a></li>
                <li><a href="#">MotoGP™ Predictor</a></li>
                <li><a href="#">MotoGP™ eSport</a></li>
                <li><a href="#">MotoGP™ Guru</a></li>
                <li><a href="#">MotoGP™25</a></li>
              </ul>
            </div>
          ...
          <div className="flex justify-between items-center border-b px-10">
            <div className="flex gap-4 items-center">
              <p className="text-lg font-semibold">Download the Official <br /> MotoGP™ App</p>
            ...
            <div className="flex flex-wrap gap-8 py-8 text-gray-500 text-xl justify-end">
              ...
              <a href="#"><i className="fab fa-threads hover:text-black"></i></a>
              <a href="#"><i className="fab fa-x-twitter hover:text-black"></i></a>
              <a href="#"><i className="fab fa-tiktok hover:text-black"></i></a>
              <a href="#"><i className="fab fa-youtube hover:text-black"></i></a>
              <a href="#"><i className="fab fa-linkedin-in hover:text-black"></i></a>
              <a href="#"><i className="fas fa-podcast hover:text-black"></i></a>
              <a href="#"><i className="fab fa-snapchat-ghost hover:text-black"></i></a>
              <a href="#"><i className="fab fa-twitch hover:text-black"></i></a>
              {/* 2 icon cuối */}
              <div className="w-full flex gap-4 justify-end">
                <a href="#"><i className="fab fa-whatsapp hover:text-black"></i></a>
                <a href="#"><i className="fab fa-telegram-plane hover:text-black"></i></a>
              </div>
            </div>
