  ...
  return (
    <Layout>
      ...
      >
        <div
          className={
            "text-white text-2xl font-bold text-center py-4 flex items-center justify-center"
          }
        >
          <svg
            width="40"
      ...
      <Layout>
        <Header
          className={"border border-gray-200 sticky top-0 z-10 p-0 bg-white"}
        >
